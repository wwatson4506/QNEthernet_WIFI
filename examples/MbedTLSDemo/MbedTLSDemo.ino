...
//    (In the qnethernet_opts.h library file or the project
//    build options.)
...
//    information.
// 4. Update src/mbedtls/config.h in the Mbed TLS library with the
//    desired options. A sample config is in this project. Simply
//    cut & paste.
//
